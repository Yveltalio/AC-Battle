...
vector<Attaque> AttributionAttaque(std::string nom_perso)
{
    ...
    if (nom_perso == "Altair")
    {
        ...
        string description = "Attaque l'ennemi avec la celebre epee d'Altair";
        Attaque Attaque2 = Attaque("Epee d'Altair",description,15, 10);

        string description = "Attaque l'ennemi avec la celebre dague d'Altair";
    ...
    if (nom_perso == "Ezio")
    {
        ...
        string description = "Attaque l'ennemi avec la celebre epee d'Ezio";
        Attaque Attaque2 = Attaque("Epee d'Ezio",description,15, 10);

        string description = "Prend ces distances pour attaquer l'ennemi avec son arbalete";
    ...
    if (nom_perso == "Edward")
    {
        ...
        string description = "Edward brandit ces 2 lames et saute sur l'ennemi pour l'attaquer";
        Attaque Attaque2 = Attaque("Double epee",description,20, 25);

        string description = "Grace a sa dexterite, Edward brandit ces pistolets pour infliger de lourds degats a la cible";
    ...
    if (nom_perso == "Bayek")
    {
        ...
        string description = "Bayek fait appel a Senu pour infliger des degats a la cible";
        Attaque Attaque2 = Attaque("Oiseau Senu",description,10, 0);

        string description = "Prend ces distances pour attaquer l'ennemi avec son arc";
    ...
    if (nom_perso == "Eivor")
    {
        ...
        string description = "Attaque l'ennemi avec des haches nordiques";
        Attaque Attaque2 = Attaque("Lance de haches",description,30, 45);

        string description = "Prend ces distances pour preparer une fleche explosive et la decoche sur la cible";
...
///////////////////////////////////////////////////////////////////////////////
    ...
    if (nom_perso == "Vieri")
    {
        ...
        string description = "Vieri brandit son epee et attaque l'ennemi";
        Attaque Attaque2 = Attaque("Epee",description,20, 25);

        string description = "Confiant de sa force, Vieri attaque son adversaire a main nue";
    ...
    if (nom_perso == "Uberto")
    {
        ...
        string description = "Manie une lance pour infliger des degats tout en gardant une distance avec son adversaire";
        Attaque Attaque2 = Attaque("Lance",description,25, 25);

        string description = "Confiant de sa force, Uberto attaque son adversaire a main nue";
        Attaque Attaque3 = Attaque("Coup de poing",description,10, 10);
    ...
    if (nom_perso == "Haytham")
    {
        ...
        string description = "Haytham brandit sa celebre epee et attaque la cible";
        Attaque Attaque2 = Attaque("Epee d'Haytham",description,20, 25);

        string description = "Haytham prend ces distances pour tirer sur la cible";
    ...
    if (nom_perso == "Jacob")
    {
        ...
        string description = "Attaque l'ennemi avec une canne qui peut servir d'epee";
        Attaque Attaque2 = Attaque("Canne epee de jacob",description,20, 25);

        string description = "Prend ces distances pour attaquer la cible avec des couteaux";
    ...
    if (nom_perso == "Fulke")
    {
        ...
        string description = "Enferme l'ennemi petit a petit dans un coin afin de lui assemer des coups de bouclier";
